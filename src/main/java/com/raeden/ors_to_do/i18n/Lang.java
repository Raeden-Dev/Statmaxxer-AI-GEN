...
public enum Lang {
    ...
    CAL_BTN_ADD_SCENARIO("＋ Add Custom Scenario"),
    ...
    CAL_MENU_ADD_SCENARIO("Add Custom Scenario…"),
    CAL_MENU_EDIT_JOURNAL("Edit Journal Entry"),
    CAL_MENU_CUSTOMIZE_DAY("Customize Day…"),
    CAL_MENU_RESET_STYLE("Reset Day Style"),
    ...
    CAL_DLG_ADD_SCENARIO("Add Custom Scenario"),
    CAL_DLG_EDIT_SCENARIO("Edit Custom Scenario"),
    CAL_LBL_SCENARIO_TAG("Tag Name:"),
    CAL_PROMPT_SCENARIO_TAG("e.g. Workout, Travel, Sick Day"),
    CAL_LBL_TAG_COLOR("Tag Color:"),
    ...
    CAL_ENTRY_TAG_SCENARIO("scenario"),
    CAL_LBL_FILTER_BY_TAG("Filter:"),
    CAL_NO_ENTRIES_FOR_TAG("No entries match this tag."),
    CAL_TOAST_ENTRY_DELETED("Deleted entry"),
    CAL_TOAST_TASK_DELETED("Deleted \"{0}\""),
    CAL_TOAST_PRESET_DELETED("Deleted preset \"{0}\""),
